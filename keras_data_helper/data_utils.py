...
def load_all(train_path, test_path):
    ...
    # all_max_len['train_up_max_len'] = train_up_max_len
    # all_max_len['train_down_max_len'] = train_down_max_len
    # all_max_len['test_up_max_len'] = test_up_max_len
    # all_max_len['test_down_max_len'] = test_down_max_len
    ...
    test_data['te_sts_up'], test_data['te_sts_down'] = load_padding(sts_tokenizer,
                                                                    ...
                                                                    max_len)
    print("数据集处理完成！")
    return train_data, test_data, all_word_index, max_len

if __name__ == '__main__':
    train_data, test_data, all_word_index, max_len \
        = load_all(twitter_path[twitter_train_path], twitter_path[twitter_test_path])
    print('hehe')
